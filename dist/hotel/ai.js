            ...
            hotels: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        meals: {
                            type: "string",
                            description: "Meal plan array (e.g., Fullboard, Halfboard, Breakfast, Dinner) Halfboard means breakfast and dinner included, Fullboard means all meals included",
                        },
                        vat: {
                            type: "number",
                            description: "VAT percentage if mentioned (e.g., 10 for 1.10 VAT). 20 percent for 1.20 VAT. If it's not mentioned, vat is 1",
                        },
                        surcharge: {
                            type: "array",
                            items: {
  ...
  "hotels": [
    {
      ...
      - DO NOT return duplicate hotel objects. Each object in the hotels array must be unique.`);
        ...
        if ((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes("mimeType parameter")) {
            throw new Error(`Unsupported file type: ${mimeType}. Please try a different file format.`);
        }
        throw error;
    }
});
