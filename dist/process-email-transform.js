...
exports.processEmailForAI = exports.transformEmailData = void 0;
/**
            ...
            processedEmail.to = Array.isArray(email.toRecipients)
                ? email.toRecipients.map((recipient) => {
                    ...
                    return ({
                        ...
                        email: ((_b = recipient.emailAddress) === null || _b === void 0 ? void 0 : _b.address) || "",
                    });
                })
                : [];
        }
 ...
 */
function transformEmailData(rawEmail) {
...
exports.transformEmailData = transformEmailData;
